  ...
  return <>
    <div className="main-container">
      ...
      <div className="box">
        ...
        <Tooltip id="b" show={freqStore['tooltip_b']} onClick={handleTooltipClick({ key: 'tooltip_b' })} />
      </div>
      <div className="box">
      ...
      <div className="box">
        ...
        <Tooltip id="d" show={freqStore['tooltip_d']} onClick={handleTooltipDClick} />
      </div>
      ...
      <div className="box" onClick={handleBoxClick({ key: 'badge_f' })}>
        ...
        <Tooltip id="f" show={freqStore['tooltip_f']} onClick={handleTooltipFClick} />
      </div>
      <div className="box">
        <div className="content">G</div>
        <Tooltip id="g" show={freqStore['tooltip_g']} onClick={handleTooltipClick({ key: 'tooltip_g' })} />
      </div>
      <div className="box">
